                 ...
                 Container(
                   ...
                   child: Column(
                     children: [
                       Row(
                         children: [
                           Text("Last 5 Transactions of "+ date,style: TextStyle(fontSize: 20),)
                         ],
                       )
                     ],
                   ),
                             ...
                             children: [
                               ...
                               Column(
                                 ...
                                 children: [
                                   Row(
                                     children: [
                                       Image.asset("assets/images/sbi logo.png",
                                         height: 50, width: 50,),
                                       Spacer(
                                         flex: 1,
                                       ),
                                       Column(
                                         ...
                                         children: [
                                           ...
                                           Text(transactions![i].transactionType!),
                                           SizedBox(
                                             height: 6,
                                           ),
           ...
           Container(
             ...
             child: Column(
               children: [
                 Row(
                   children: [
                     Text("Last 5 Transactions of ",style: TextStyle(fontSize: 20),)
                   ],
                 )
               ],
             ),
               ...
               children: [
                 Column(
                   children: [
                     Row(
                       children: [
                         Text("!Full date!",style: TextStyle(fontSize: 14),)
                       ],
                     ),
                   ],
                 ),
                 ...
                 Column(
                   ...
                   children: [
                     Row(
                       children: [
                         Image.asset("assets/images/sbi logo.png",height: 50,width: 50,),
                         Spacer(
                           flex: 1,
                         ),
                         Column(
